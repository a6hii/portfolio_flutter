...
class ProjectsTabView extends StatefulWidget {
  ...
  @override
  State<ProjectsTabView> createState() => _ProjectsTabViewState();
}
...
class _ProjectsTabViewState extends State<ProjectsTabView> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          WorkHeading(context: context, title: 'Some things I\'ve built'),
          const Divider(
            color: Colors.white,
            thickness: 2,
            indent: 10,
         ...
         const SizedBox(
          ...
          Project(
            ...
            featuredProjectTitle: 'Published Android app[Deprecated]',
            projectExternalUrl:
